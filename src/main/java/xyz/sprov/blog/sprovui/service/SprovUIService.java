...
public class SprovUIService {
    ...
    private static final String GITHUB_LAST_RELEASE_URL = "https://github.com/yeyuehuo/sprov-ui/releases/latest";
    ...
    private String getLastDownloadUrl() {
        return "https://github.com/yeyuehuo/sprov-ui/releases/download/" + lastVersion + "/sprov-ui-" + lastVersion + ".jar";
    }
