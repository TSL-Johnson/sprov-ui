...
public class Config {
    ...
    static {
        ...
        try {
            ...
            properties.setProperty("loginFooter", "Github - <a href=\"https://github.com/yeyuehuo/sprov-ui\" target=\"_blank\">sprov-ui</a>"); // 登录页面 Foot
            try {
...
//        return properties.getProperty("basePath", "");
    ...
    public static String loginFooter() {
        return properties.getProperty("loginFooter", "Github - <a href=\"https://github.com/yeyuehuo/sprov-ui\" target=\"_blank\">sprov-ui</a>");
    }
